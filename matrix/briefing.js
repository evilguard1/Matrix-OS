...
const FILES=["bootstrap.js","early.js","early-progression.js","start.js","services/hacking.js","services/coordinator.js","services/singularity.js","workers/singularity/backdoors.js","dashboard.jsx","control.js"];
...
export function collectBriefing(ns,now=Date.now()) {
    ...
    return buildBriefing({now,reset:{...reset,sourceFiles:[...(reset.ownedSF?.entries?.()??[])]},states,files,processes,
        ...
        selfRam:ns.getScriptRam("/matrix/briefing.js","home"),control,controlError,configuration,configurationError,manifestValid,
