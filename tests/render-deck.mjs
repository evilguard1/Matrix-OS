...
const shapes = {
    ...
    "prep sweep running": { ...base, services: { hacking: { status: "batching", target: "phantasy",
        utilisation: 0.83, prep: { targets: 7, threads: 41200, ram: 7.2e4 } } } },
    "prep sweep malformed": { ...base, services: { hacking: { status: "batching", prep: { targets: "x", threads: null } } } },
    "multi-target wave": { ...base, services: { hacking: { status: "batching", phase: "HWGW", target: "phantasy",
        batches: 640, utilisation: 0.72, waveRam: 5.8e5, freeRam: 8.04e5,
        targets: [{ host: "phantasy", batches: 125, ram: 9e4 }, { host: "omega-net", batches: 125, ram: 8e4 }] } } },
